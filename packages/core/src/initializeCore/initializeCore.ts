import { EventListener, Core, EventListenerCallback } from '../types';
 ...
 */
export function initializeCore({ extensionId }: InitializeCoreOptions): Core {
  const core: Core = {
    extensionId,
    ...
    addEventListener: (type, callback) =>
      eventListeners.push({
        source: extensionId,
        type,
        callback: callback as EventListenerCallback<string, any>,
      }),
