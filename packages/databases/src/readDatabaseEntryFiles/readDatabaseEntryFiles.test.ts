...
describe('readDatabaseEntryFiles', () => {
  ...
  it('reads and deserializes entry files from a database', async () => {
    ...
    const entries = await readDatabaseEntryFiles(objectDatabase);
  ...
  it('reads entries from an entry-based storage database', async () => {
    ...
    const entries = await readDatabaseEntryFiles(entryStorageDatabase);
