...
> = {
  ...
  callback: updateDatabaseEntryWithMetadata,
...
async function updateDatabaseEntryWithMetadata(
  ...
  await updateDatabaseEntry(updatedDatabaseEntry.path, {
    properties,
  });
}
