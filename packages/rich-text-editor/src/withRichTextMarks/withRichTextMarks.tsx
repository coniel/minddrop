...
export function withRichTextMarks(
  editor: Editor,
  markConfigs: RichTextMarkConfig[],
  ...
  editor.apply = (operation) => {
    ...
    if (operation.type === 'split_node') {
      ...
      const newElement = Node.get(editor, newElementPath) as RichTextElement;
  ...
  const renderLeaf = (props: RenderLeafProps) => {
    ...
    const configs: Record<string, RichTextMarkConfig> = markConfigs.reduce(
