...
const slashCommand: RTInlineMenuConfig = {
  character: '/',
  onOpen: jest.fn(),
...
const atCommand: RTInlineMenuConfig = {
  character: '@',
  onOpen: jest.fn(),
  onQueryChange: jest.fn(),
  close: jest.fn(),
...
describe('withInlineMenu', () => {
  ...
  it('closes the menu if text is inserted at the trigger point', () => {
