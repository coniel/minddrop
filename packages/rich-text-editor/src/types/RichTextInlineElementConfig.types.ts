...
> {
  ...
  component: React.ElementType<
    RichTextInlineElementProps<RichTextInlineElement<TTypeData>>
  >;
   ...
   *
   * @returns A rich text inline element.
   */
  initialize?(): RichTextInlineElement;
   ...
   */
  toPlainText?(element: RichTextInlineElement<TTypeData>): string;
   ...
   */
  toMarkdown?(element: RichTextInlineElement<TTypeData>): string;
