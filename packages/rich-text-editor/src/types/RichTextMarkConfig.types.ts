...
export interface RichTextMarkHotkey {
  /**
...
export interface RichTextMarkShortcut {
  /**
...
export interface RichTextMarkConfig {
  /**
   ...
   */
  hotkeys?: RichTextMarkHotkey[];

  /**
   * Markdown style shorcuts which enable this mark.
   *
   */
  shortcuts?: RichTextMarkShortcut[];
