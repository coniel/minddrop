import { RTBlockElement, RTFragment } from '@minddrop/rich-text';
import { RenderLeafProps } from 'slate-react';
import { InlineShortcutWrapTrigger } from './InlineShortcut.types';

export interface RTMarkHotkey {
  /**
...
export interface RTMarkShortcut {
  /**
