  ...
  return (
    ...
    >
      ...
      >
        ...
        <Separator
          size="2"
          css={{ mb: '$4', display: 'block', '@bp1': { display: 'none' } }}
        />

        <Box css={{ mb: '$2' }}>
          <Link
            variant="blue"
            href={`https://github.com/coniel/minddrop/tree/main/packages/${frontmatter.package}/src/${frontmatter.name}`}
            target="_blank"
          >
        ...
        <Box css={{ mb: '$2' }}>
          <Link
            variant="blue"
            href="https://github.com/coniel/minddrop/issues/new/choose"
            target="_blank"
          >
            <Flex css={{ display: 'inline-flex', position: 'relative' }}>
              <Text size="2" css={{ display: 'inline', lineHeight: '15px' }}>
