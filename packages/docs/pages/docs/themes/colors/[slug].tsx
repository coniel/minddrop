...
export default function ThemesPaletteCompostionDoc({ frontmatter, code }: Doc) {
...
export async function getStaticPaths() {
  const frontmatters = getAllFrontmatter('themes/colors');

  return {
    paths: frontmatters.map((frontmatter) => ({
      params: {
        slug: frontmatter.slug.replace('themes/colors/', ''),
      },
    })),
    fallback: false,
  };
