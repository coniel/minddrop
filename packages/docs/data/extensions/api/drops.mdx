...
<InterfaceTable
  data={[
    ...
    },
    {
      ...
      type: 'string[]',
      description:
        "IDs of the drop's files. All files attached to the drop must be listed here. The file references of attached files will be automatically updated, adding the drop as an attached resource.",
    },
    {
      name: 'color',
      type: 'ContentColor',
