...
/**
 * Stringifies an array of block elements to markdown.
 *
 * @param elementConfigs - The block element configs to use for stringification.
 * @param elements - The block elements to stringify.
 * @returns The markdown string.
 */
export function stringifyBlockElementsToMarkdown(
  elements: BlockElement[],
  elementConfigs = BlockElementConfigsStore.getAll(),
): string {
  let index = 0;
