 ...
 */
export const parseBookmarkElementFromMarkdown: BlockElementParser<
  BookmarkElement
> = (line, consume): BookmarkElement | null => {
  ...
  if (match && match[1] && match[2]) {
    ...
    return generateVoidBlockElement<BookmarkElement>('bookmark', {
      title: match[1],
      url: match[2],
      description: match[3] || '',
    });
