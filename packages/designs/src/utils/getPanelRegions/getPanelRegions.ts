...
/**
 * The content region of a panelled page root: a container playing
 * the structural page-content role.
 */
export type PanelContentRegion = RoleDesignElement<ContainerElement>;
