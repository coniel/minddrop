...
const ElementGroups: {
  ...
  { key: 'date', label: 'designs.layout-property-mapping.browser.dateGroup' },
  ...
  {
    key: 'view',
    label: 'designs.layout-property-mapping.browser.collectionGroup',
  },
];
  ...
  return (
    <div className="layout-browser-list">
      ...
      <div className="layout-browser-header">
        <IconButton
          icon="chevron-left"
          label="designs.layout-property-mapping.browser.backToLayouts"
          color="neutral"
          onClick={onBack}
        />
        <TextInput
          variant="subtle"
          size="md"
          placeholder="designs.layout-property-mapping.browser.searchProperties"
        ...
        <IconButton
          icon="plus"
          label="designs.layout-property-mapping.browser.addProperty"
          color="neutral"
        />
      </div>
