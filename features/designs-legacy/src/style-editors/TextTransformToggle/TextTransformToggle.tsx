...
import { TextTransform } from '@minddrop/designs-legacy';
...
const options: (StyleOption<TextTransform> & {
  ...
  {
    value: 'uppercase',
    label: 'designs.typography.text-transform.uppercase',
    children: 'designs.typography.text-transform.uppercase-short',
  },
  {
    value: 'lowercase',
    label: 'designs.typography.text-transform.lowercase',
    children: 'designs.typography.text-transform.lowercase-short',
  },
  {
    value: 'capitalize',
    label: 'designs.typography.text-transform.capitalize',
    children: 'designs.typography.text-transform.capitalize-short',
  },
];
