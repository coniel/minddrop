 ...
 * tallest letters to the bottom of its lowest: fixed-height
 * headings hold a single line, natural-height ones wrap into a line
 * per block height.
 */
...
> = ({ element }) => {
  ...
  const textClassName = joinClasses(
    ...
    !element.naturalHeight && 'design-heading-element-single-line',
