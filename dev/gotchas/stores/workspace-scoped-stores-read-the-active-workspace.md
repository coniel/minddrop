...
summary: "A store created with scope: 'workspace' reads and writes the active workspace's record; clear() and load() before a workspace is active go to a default record the app never reads"
paths:
