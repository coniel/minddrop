...
export const SeparatorStories = () => (
  <Story title="Separator">
    ...
    <StorySection
      title="Orientation"
      description="Horizontal fills container width. Vertical fills container height — parent needs a defined height."
    >
      <StoryRow>
    ...
    <StorySection
      title="Margin"
      description="Equal margin on both sides. small for menus, medium for section dividers, large for page-level separation."
    >
      <StoryRow>
