...
export const TabsStories = () => {
  ...
  return (
    <Story title="Tabs">
      ...
      <StorySection
        title="Basic"
        description="Uncontrolled tabs with defaultValue."
      >
        <StoryRow>
      ...
      <StorySection
        title="With icons"
        description="Tabs with a startIcon before the label text."
      >
        <StoryRow>
          <StoryItem label="startIcon">
            <Tabs defaultValue="documents">
              <TabsList>
                <TabsTab value="documents" startIcon="file-text">
                  Documents
                </TabsTab>
                <TabsTab value="images" startIcon="image">
                  Images
                </TabsTab>
                <TabsTab value="settings" startIcon="settings">
                  Settings
                </TabsTab>
              </TabsList>
            </Tabs>
      ...
      <StorySection
        title="Sizes"
        description="Size is set on each TabsTab. Matches Button size scale."
      >
        <StoryRow>
          <StoryItem label="sm">
            <Tabs defaultValue="one">
              <TabsList>
                <TabsTab value="one" size="sm" startIcon="file-text">
                  Tab one
                </TabsTab>
                <TabsTab value="two" size="sm" startIcon="image">
                  Tab two
                </TabsTab>
                <TabsTab value="three" size="sm" startIcon="settings">
                  Tab three
                </TabsTab>
              </TabsList>
            </Tabs>
          ...
          <StoryItem label="md (default)">
            <Tabs defaultValue="one">
              <TabsList>
                <TabsTab value="one" size="md" startIcon="file-text">
                  Tab one
                </TabsTab>
                <TabsTab value="two" size="md" startIcon="image">
                  Tab two
                </TabsTab>
                <TabsTab value="three" size="md" startIcon="settings">
                  Tab three
                </TabsTab>
              </TabsList>
            </Tabs>
          ...
          <StoryItem label="lg">
            <Tabs defaultValue="one">
              <TabsList>
                <TabsTab value="one" size="lg" startIcon="file-text">
                  Tab one
                </TabsTab>
                <TabsTab value="two" size="lg" startIcon="image">
                  Tab two
                </TabsTab>
                <TabsTab value="three" size="lg" startIcon="settings">
                  Tab three
                </TabsTab>
              </TabsList>
            </Tabs>
      ...
      <StorySection
        title="Controlled"
        description="Value managed via useState. Active: {controlled}."
      >
        <StoryRow>
      ...
      >
        <StoryRow>
          <StoryItem label="middle tab disabled">
            <Tabs defaultValue="one">
              <TabsList>
                <TabsTab value="one" startIcon="file-text">
                  Tab one
                </TabsTab>
                <TabsTab value="two" startIcon="image" disabled>
                  Tab two
                </TabsTab>
                <TabsTab value="three" startIcon="settings">
                  Tab three
                </TabsTab>
              </TabsList>
            </Tabs>
