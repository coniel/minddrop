import type { DatabaseRenamedEventData } from '@minddrop/databases';
...
/**
 * Handles database renamed events by syncing the renamed
 * database metadata to SQL and dispatching a synced event.
 */
