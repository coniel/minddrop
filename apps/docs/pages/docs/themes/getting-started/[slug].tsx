...
export default function ThemesGettingStartedDoc({ frontmatter, code }: Doc) {
...
export async function getStaticPaths() {
  const frontmatters = getAllFrontmatter('themes/getting-started');

  return {
    paths: frontmatters.map((frontmatter) => ({
      params: { slug: frontmatter.slug.replace('themes/getting-started/', '') },
    })),
    fallback: false,
  };
}
