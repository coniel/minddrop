---
metaTitle: RTBlockElement Interface
...
In rich text documents, elements such as paragraphs, list items, images, etc. are created using `RTBlockElement` objects.
    ...
    },
    {
      ...
      description: (
        <p>
          ...
          contain a reference to a <Code>RTDocument</Code> (the
          rich text document in which the element is found) and a{' '}
          <Code>RTBlockElement</Code> if the element is nested
