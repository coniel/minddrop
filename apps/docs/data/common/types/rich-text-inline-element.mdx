...
In rich text documents, elements such as links, equations, etc. are created using `RTInlineElement` objects.
    ...
    },
    {
      ...
      description: (
        <p>
          ...
          contain a reference to a <Code>RTBlockElement</Code>{' '}
          (the rich text block in which the element is found) and a{' '}
          <Code>RTDocument</Code> (the rich text document in
