---
metaTitle: TopicView Interface
metaDescription: An interface for describing topic views.
---

# TopicView

<Description>An interface for describing topic views.</Description>
...
<InterfaceTable
  data={[
    ...
    },
    {
      ...
      required: true,
      description:
        'The ID of the extension that registered the topic view.',
    },
    {
      name: 'name',
      type: 'string',
