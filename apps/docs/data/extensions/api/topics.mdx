...
<ArgsTable
  data={[
    {
        name: 'descendantTopicId',
        type: 'string',
        required: true,
        description: 'The ID of the topic which may be a descendant.'
    },
    {
        name: 'parentTopicIds',
        type: 'string',
        required: true,
        description: 'The IDs of the topics which may be a parent.'
    },
  ]}
/>
...
<ArgsTable core data={[
    ...
    },
    {
      name: 'position',
      type: 'number',
      description: 'The index at which to add the subtopics.',
    },
...
<ArgsTable core data={[
    ...
    },
    {
      name: 'position',
      type: 'number',
      description: 'The index at which to add the moved subtopics.',
    },
  ...
  data={[
    {
      ...
      required: true,
      description:
        'The IDs of the topic in which to sort the subtopics.',
    },
    {
      name: 'subtopicIds',
      type: 'string[]',
...
<EventsTable
  data={[
    ...
    {
      name: 'topics:move-drops',
      data: 'MoveDropsEventData',
      description:
        'Dispatched when drops are moved from one topic to another.',
    },
    {
...
<InterfaceTable
  data={[
    ...
    },
    {
      ...
      type: 'DropMap',
      required: true,
      description: 'The drops which were moved.',
    },
  ]}
/>
