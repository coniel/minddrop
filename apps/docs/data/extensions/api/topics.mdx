...
Archives drops in a topic and dirspatches a `topics:archive-drops` event as well as a `topics:update` event. Returns the updated topic.
...
Unarchives drops in a topic and dirspatches a `topics:unarchive-drops` event as well as a `topics:update` event. Returns the updated topic.
