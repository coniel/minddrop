...
Adds rich text block elements to the document's children and dispatches a `rich-text-documents:add-elements` event. Returns the updated document.

Sets the document as a parent on the added elements.
  ...
  data={[
    {
      ...
      required: true,
      description:
        'The ID of the rich text document into which to add the elements.',
    },
    {
      name: 'elementIds',
      type: 'string[]',
      required: true,
      description:
        'The IDs of the rich text block elements to add to the document.',
    },
  ]}
/>
...
Removes rich text block elements from the document's children and dispatches a `rich-text-documents:remove-elements` event. Returns the updated document.

Removes the document as a parent from the removed elements.

- Throws a `RichTextDocumentNotFoundError` if the rich text document does not exist.
- Throws a `RichTextElementNotFoundError` if any of the rich text block elements do not exist.

```ts
RichTextDocuments.removeElements(
  core: Core,
  documentId: string,
  elementIds: string,
): RichTextDocument
  ...
  data={[
    {
      ...
      required: true,
      description:
        'The ID of the rich text document from which to remove the elements.',
    },
    {
      name: 'elementIds',
      type: 'string[]',
      required: true,
      description:
        'The IDs of the rich text block elements to remove from the document.',
    },
  ]}
/>
...
Reorders a document's children and dispatches a `rich-text-documents:reorder-elements` event. Returns the updated document.

The `reorderedElementIds` parameter must contain exactly the same IDs as the current version of the document contains in `children`, only in a different order.

- Throws a `RichTextDocumentNotFoundError` if the rich text document does not exist.
- Throws a `RichTextDocumentValidationError` if `reorderedElementIds` does not contain the same IDs as currently found in the document's `children`.

```ts
RichTextDocuments.reorderElements(
  core: Core,
  documentId: string,
  ...
  data={[
    {
      ...
      required: true,
      description:
        'The ID of the rich text document in which to reorder the elements.',
    },
    {
      name: 'reorderedElementIds',
      type: 'string[]',
      required: true,
      description:
        "The reordered IDs of the rich text block elements making up the document's root level content.",
    },
  ]}
/>
...
<EventsTable
  data={[
    ...
    {
      name: 'rich-text-documents:add-elements',
      data: 'AddRichTextDocumentElementsEventData',
      description:
        "Dispatched when rich text block elements are added to a rich text document's children.",
    },
    {
      name: 'rich-text-documents:remove-elements',
      data: 'RemoveRichTextDocumentElementsEventData',
      description:
        "Dispatched when rich text block elements are removed from the rich text document's children.",
    },
    {
      name: 'rich-text-documents:reorder-elements',
      data: 'ReorderElementsInRichTextDocumentEventData',
      description:
        "Dispatched when a rich text document's children are reordered.",
    },
    {
...
#### AddElementsToRichTextDocumentEventData
  ...
  data={[
    {
      ...
      required: true,
      description:
        'The rich text document to which the elements were added.',
    },
    {
      name: 'elements',
...
#### RemoveElementsFromRichTextDocumentEventData
  ...
  data={[
    {
      ...
      required: true,
      description:
        'The rich text document from which the elements were removed.',
    },
    {
      name: 'elements',
      type: 'RichTextBlockElementMap',
...
#### ReorderElementsInRichTextDocumentEventData
  ...
  data={[
    {
      ...
      required: true,
      description:
        'The rich text document in which the elements were reordered.',
    },
    {
      name: 'elementsBefore',
      ...
      required: true,
      description:
        "The document's rich text block elements in the order which they appeared before being reordered.",
    },
    {
      name: 'elementsAfter',
      type: 'RichTextBlockElement[]',
      required: true,
      description:
        "The document's rich text block elements in the order which they appear after being reordered.",
    },
  ]}
/>
