  ...
  data={[
    {
      ...
      type: 'string',
      required: true,
      description: 'The ID of the drop for which to retrieve the data insert.',
    },
  ]}
/>
  ...
  data={[
    {
      ...
      type: 'string',
      required: true,
      description: 'The drop type for which to retrieve the config.',
    },
  ]}
/>
...
<ArgsTable
  ...
  data={[
    ...
    },
    {
      ...
      description: (
        <span>
          The parent references to add to the drop. See the{' '}
          <a href="/docs/extensions/types/drop#dropparentreference">
            <Code>DropParentReference</Code>
          </a>{' '}
...
<ArgsTable
  ...
  data={[
    ...
    },
    {
      ...
      description: (
        <span>
          The parent references to remove from the drop. See the{' '}
          <a href="/docs/extensions/types/drop#dropparentreference">
            <Code>DropParentReference</Code>
          </a>{' '}
          interface for details.
...
See the [DropParentReference](/docs/extensions/types/drop#dropparentreference) interface.
...
<InterfaceTable
  data={[
    ...
    {
      name: 'parents',
      type: 'DropParentReference[] | ArrayUnion | ArrayFilter',
      description: "The references of the drops's parents.",
    },
    {
      name: 'tags',
      type: 'string[] | ArrayUnion | ArrayRemove',
...
<InterfaceTable
  data={[
    ...
    },
    {
      ...
      required: true,
      description:
        'The references of the parents which were added to the drop.',
    },
  ]}
/>
