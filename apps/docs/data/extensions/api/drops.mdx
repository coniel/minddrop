...
Adds parent IDs to a drop and dispatches a `drops:add-parents` event and a `drops:update` event. Returns the updated drop.

```ts
Drops.addParents(core: Core, dropId: string, parentIds: string[]): Drop
```
  ...
  data={[
    {
      ...
      type: 'string',
      required: true,
      description: 'The ID of the drop to which to add the parents.',
    },
    {
      name: 'parentIds',
      type: 'string[]',
      required: true,
      description: 'The IDs of the parents to add to the drop.',
    },
  ]}
/>
...
Remove parent IDs from a drop and dispatches a `drops:remove-parents` event and a `drops:update` event. Returns the updated drop.

```ts
Drops.removeParents(core: Core, dropId: string, parentIds: string[]): Drop
```
  ...
  data={[
    {
      ...
      required: true,
      description:
        'The ID of the drop from which to remove the parents.',
    },
    {
      name: 'parentIds',
      type: 'string[]',
      required: true,
      description: 'The IDs of the parents to remove from the drop.',
    },
  ]}
/>
...
<EventsTable
  data={[
    ...
    {
      name: 'drops:add-parents',
      data: 'AddParentsEventData',
      description: 'Dispatched when parents are added to a drop.',
    },
    {
      name: 'drops:remove-parents',
      data: 'RemoveParentsEventData',
      description: 'Dispatched when parents are removed from a drop.',
    },
    {
      name: 'drops:add-tags',
  ...
  data={[
    {
      ...
      type: 'Drop',
      required: true,
      description: 'The drop to which the parents were added.',
    },
    {
      name: 'parents',
      type: 'string[]',
      required: true,
      description:
        'The IDs of the parents which were added to the drop.',
    },
  ]}
/>
  ...
  data={[
    {
      ...
      type: 'Drop',
      required: true,
      description: 'The drop from which the parents were removed.',
    },
    {
      name: 'parents',
      type: 'string[]',
...
<InterfaceTable
  data={[
    ...
    },
    {
      ...
      type: 'TagMap',
      required: true,
      description: 'The tags which were added to the drop.',
    },
  ]}
/>
...
<InterfaceTable
  data={[
    ...
    },
    {
      ...
      type: 'TagMap',
      required: true,
      description: 'The tags which were removed from the drop.',
    },
  ]}
/>
...
<InterfaceTable
  data={[
    ...
    },
    {
      ...
      required: true,
      description:
        'The file references of the files which were added to the drop.',
    },
  ]}
/>
...
<InterfaceTable
  data={[
    ...
    },
    {
      ...
      required: true,
      description:
        'The files references of the files which were removed from the drop.',
    },
  ]}
/>
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      type: 'boolean',
      default: 'true',
      description: 'Include active drops (drops which not deleted).',
    },
    {
      name: 'deleted',
      type: 'boolean',
